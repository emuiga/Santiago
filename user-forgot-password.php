...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM tblpatrons WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblpatrons set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<head>
    ...
    <title>N.C.A Library Management System | Password Recovery </title>
